...
public class AlgaeShoot extends Command {
  ...
  public AlgaeShoot(ClawSubsystem claw, ClawWheelSubsystem clawWheel, double setpoint, LiftSubsystem lift) {
    m_claw = claw;
    m_clawWheel = clawWheel;
  ...
  public void execute() {
    ...
    {
      m_clawWheel.m_WheelMotor.set(-kWheelShootSpeed);
    }
    else 
    {
      m_clawWheel.m_WheelMotor.set(0.1);
    }
