...
public class PID_SetClawPosition extends Command {
  ...
  public PID_SetClawPosition(ClawSubsystem claw, double setpoint, boolean inAuto) {
    m_claw = claw;
...
/*
  ...
  public boolean isFinished() {
    ...
    return ((m_claw.m_RotationalMotor.getPosition().getValueAsDouble() < setpoint + kEps_claw)&&(m_claw.m_RotationalMotor.getPosition().getValueAsDouble() > setpoint - kEps_claw)&& inAuto);
  }
}
